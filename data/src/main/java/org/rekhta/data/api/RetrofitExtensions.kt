...
import org.ibis.base.ErrorResult
import org.ibis.base.Mapper
import org.ibis.base.Result
import org.ibis.base.Success
import org.rekhta.data.errorLog
...
suspend fun <T> Response<T>.toResult(): Result<T> = try {
    if (isSuccessful) {
...
suspend fun <T, E> Response<T>.toResult(mapper: Mapper<T, E>): Result<E> =
    toResult { mapper.map(it) }
